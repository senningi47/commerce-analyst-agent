...
预算: **平台实扣终账 91.06 元 /160 ✓（57%，2026-09-19 对账，含 sim 侧）**；收官估算 88.19 差 +2.87（≈3.3%：sim + 汇率漂移）已归因留档；peak 零泄漏获平台旁证
