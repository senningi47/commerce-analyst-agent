...
Day 6 Phase A: Task 1–6 完成（提交语义排查 / spool 导入接线 / 探针门翻 PASS / v2 decide 三方一致性守卫
         + 旧探针退役 / c-a 策略修复：prompt-policies v3 + c-mode 澄清预算闸 / Runner SIGINT 恢复演练=验收门② PASS）；
         离线 844 passed / 129 skipped；Ruff 全绿；PG 129 passed
下一步: Task 7 SSE 事件面（api/ 全新）→ Task 8 关键 UI（web/）→ Task 9 安全/E2E
